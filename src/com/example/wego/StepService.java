...
public class StepService extends Service {
	private static final String TAG = "com.example.wego.StepService";
    ...
    public void saveData()
    {
        ...
        time.setToNow();
        String datetoNow = time.year + "Äê" + time.month + "ÔÂ" + time.monthDay + "ÈÕ  "
        		 		  +time.hour + ":" + time.minute + ":" + time.second; 
        mStateEditor.putString("startDate",datetoNow);
        mStateEditor.commit();
    }
